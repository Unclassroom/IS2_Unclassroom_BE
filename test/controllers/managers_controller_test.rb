...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { cc: @manager.cc, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name } }, as: :json
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { cc: @manager.cc, email: @manager.email, first_name: @manager.first_name, last_name: @manager.last_name } }, as: :json
    assert_response 200
  end
